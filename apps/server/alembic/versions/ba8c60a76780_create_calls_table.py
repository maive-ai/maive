...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Cognito user ID (sub)",
        ),
        sa.Column(
            "project_id",
            sa.String(length=255),
            nullable=False,
            comment="Project/Job ID",
        ),
        sa.Column(
            "call_id", sa.String(length=255), nullable=False, comment="Provider call ID"
        ),
        sa.Column(
            "provider",
            sa.String(length=50),
            nullable=False,
            comment="Voice AI provider (vapi, etc.)",
        ),
        sa.Column(
            "status",
            sa.String(length=50),
            nullable=False,
            comment="Current call status",
        ),
        sa.Column(
            "phone_number",
            sa.String(length=20),
            nullable=False,
            comment="Phone number called",
        ),
        sa.Column(
            "is_active",
            sa.Boolean(),
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="WebSocket URL for listening to call",
        ),
        sa.Column(
            "started_at",
    ...
    op.create_index(
        "idx_project_started", "calls", ["project_id", "started_at"], unique=False
    )
    op.create_index(
        "idx_user_started", "calls", ["user_id", "started_at"], unique=False
    )
