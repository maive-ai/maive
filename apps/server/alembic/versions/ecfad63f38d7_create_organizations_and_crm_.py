...
def upgrade() -> None:
    ...
    op.create_table(
        "organizations",
        sa.Column(
            "id", sa.String(length=36), nullable=False, comment="Organization UUID"
        ),
        sa.Column(
            "name",
    ...
    op.create_table(
        ...
        sa.Column(
            "id", sa.String(length=36), nullable=False, comment="Credential record UUID"
        ),
        sa.Column(
            "organization_id",
            sa.String(length=36),
        ...
        sa.Column(
            ...
            sa.String(length=255),
            nullable=False,
            comment="User ID who configured credentials",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    # Create indexes
    op.create_index(
        op.f("ix_organization_crm_credentials_organization_id"),
        "organization_crm_credentials",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_organization_crm_credentials_is_active"),
        "organization_crm_credentials",
        ["is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        "uq_org_active_credentials", table_name="organization_crm_credentials"
    )
    op.drop_index("idx_org_crm_active", table_name="organization_crm_credentials")
    op.drop_index(
        op.f("ix_organization_crm_credentials_is_active"),
        table_name="organization_crm_credentials",
    )
    op.drop_index(
        op.f("ix_organization_crm_credentials_organization_id"),
        table_name="organization_crm_credentials",
