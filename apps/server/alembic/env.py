...
def run_migrations_offline() -> None:
    ...
    """
    # Get database URL from environment variables (lazy loading)
...
def run_migrations_online() -> None:
    ...
    """
    # Set database URL from environment variables (lazy loading)
    config.set_main_option("sqlalchemy.url", get_database_url(async_driver=False))
