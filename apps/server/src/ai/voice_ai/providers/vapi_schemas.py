...
class VapiMonitor(BaseModel):
    ...
    listen_url: str | None = Field(
        None, alias="listenUrl", description="WebSocket URL for listening to call audio"
    )
    control_url: str | None = Field(
        None, alias="controlUrl", description="URL for controlling the call"
    )
...
class VapiCallData(BaseModel):
    ...
    metadata: VapiCallMetadata = Field(
        default_factory=VapiCallMetadata, description="Call metadata"
    )
    ...
    assistant_id: str | None = Field(
        None, alias="assistantId", description="Assistant ID"
    )
    monitor: VapiMonitor | None = Field(
        None, description="Monitor URLs for control and listening"
    )
...
class VapiClaimStatusData(BaseModel):
    ...
    payment_details: VapiPaymentDetails | None = Field(
        None, description="Payment details"
    )
    required_actions: VapiRequiredActions | None = Field(
...
class VapiMessage(BaseModel):
    ...
    started_at: str | None = Field(
        None, alias="startedAt", description="Call start time"
    )
    ended_at: str | None = Field(None, alias="endedAt", description="Call end time")
    ended_reason: str | None = Field(
        None, alias="endedReason", description="Call end reason"
    )
    ...
    duration_seconds: float | None = Field(
        None, alias="durationSeconds", description="Duration in seconds"
    )
    ...
    recording_url: str | None = Field(
        None, alias="recordingUrl", description="Recording URL"
    )
    stereo_recording_url: str | None = Field(
        None, alias="stereoRecordingUrl", description="Stereo recording URL"
    )
...
class VapiWebhookPayload(BaseModel):
    ...
    function: VapiFunction | None = Field(
        None, description="Function call data for function-call events"
    )
    transcript: str | None = Field(None, description="Transcript for transcript events")
    is_partial: bool | None = Field(
        None, alias="isPartial", description="Whether transcript is partial"
    )
    ...
    conversation: list[dict[str, Any]] | None = Field(
        None, description="Conversation for conversation-update events"
    )
    ended_reason: str | None = Field(
        None, alias="endedReason", description="End reason for status-update events"
    )
