"""Metadata models for building code documents."""
...
class CodeDocumentMetadata(BaseModel):
    ...
    code_section: str | None = Field(
        None, description="Specific section or chapter (e.g., 'Chapter 15', 'Section 1507')"
    )
    document_title: str | None = Field(
        None, description="Title of the code document"
    )
    ...
    notes: str | None = Field(
        None, description="Any additional notes or context"
    )
