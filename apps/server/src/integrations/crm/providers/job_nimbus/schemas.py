...
class JobNimbusJobResponse(BaseModel):
    ...
    date_status_change: int | None = Field(None, description="Unix timestamp of last status change", alias="dateStatusChange")
    date_start: int | None = Field(None, description="Start date timestamp", alias="dateStart")
    date_end: int | None = Field(None, description="End date timestamp", alias="dateEnd")
    all_day: bool | None = Field(None, description="Whether this is an all-day event", alias="allDay")
    all_day_start_date: str | None = Field(None, description="All-day start date", alias="allDayStartDate")
    all_day_end_date: str | None = Field(None, description="All-day end date", alias="allDayEndDate")
    ...
    # Financial - Estimates
    approved_estimate_total: float | None = Field(None, description="Approved estimate total", alias="approvedEstimateTotal")
    last_estimate: float | None = Field(None, description="Last estimate amount", alias="lastEstimate")
    last_estimate_date_estimate: int | None = Field(None, description="Last estimate date", alias="lastEstimateDateEstimate")
    last_estimate_date_created: int | None = Field(None, description="Last estimate created date", alias="lastEstimateDateCreated")
    last_estimate_number: str | None = Field(None, description="Last estimate number", alias="lastEstimateNumber")
    last_estimate_jnid: str | None = Field(None, description="Last estimate JNID", alias="lastEstimateJnid")
    
    # Financial - Invoices
    approved_invoice_total: float | None = Field(None, description="Approved invoice total", alias="approvedInvoiceTotal")
    approved_invoice_due: float | None = Field(None, description="Approved invoice due amount", alias="approvedInvoiceDue")
    last_invoice: float | None = Field(None, description="Last invoice amount", alias="lastInvoice")
    last_invoice_date_invoice: int | None = Field(None, description="Last invoice date", alias="lastInvoiceDateInvoice")
    last_invoice_date_created: int | None = Field(None, description="Last invoice created date", alias="lastInvoiceDateCreated")
    last_invoice_number: str | None = Field(None, description="Last invoice number", alias="lastInvoiceNumber")
    last_invoice_jnid: str | None = Field(None, description="Last invoice JNID", alias="lastInvoiceJnid")
    
    # Financial - Budget
    last_budget_gross_profit: float | None = Field(None, description="Last budget gross profit", alias="lastBudgetGrossProfit")
    last_budget_gross_margin: float | None = Field(None, description="Last budget gross margin", alias="lastBudgetGrossMargin")
    last_budget_revenue: float | None = Field(None, description="Last budget revenue", alias="lastBudgetRevenue")
    
    # Parent/Primary contact financials
    parent_approved_invoice_total: float | None = Field(None, description="Parent approved invoice total", alias="parentApprovedInvoiceTotal")
    parent_approved_invoice_due: float | None = Field(None, description="Parent approved invoice due", alias="parentApprovedInvoiceDue")
    parent_last_invoice: float | None = Field(None, description="Parent last invoice", alias="parentLastInvoice")
    parent_approved_estimate_total: float | None = Field(None, description="Parent approved estimate total", alias="parentApprovedEstimateTotal")
    parent_last_estimate: float | None = Field(None, description="Parent last estimate", alias="parentLastEstimate")
    
    # Parent/Primary contact info
    parent_fax_number: str | None = Field(None, description="Parent fax number", alias="parentFaxNumber")
    parent_home_phone: str | None = Field(None, description="Parent home phone", alias="parentHomePhone")
    parent_mobile_phone: str | None = Field(None, description="Parent mobile phone", alias="parentMobilePhone")
    parent_work_phone: str | None = Field(None, description="Parent work phone", alias="parentWorkPhone")
    ...
    subcontractors: list[dict] | None = Field(None, description="Subcontractors assigned")
    
    # Counts and attachments
    attachment_count: int | None = Field(None, description="Number of attachments", alias="attachmentCount")
    task_count: int | None = Field(None, description="Number of tasks", alias="taskCount")
    tags: list[str] | None = Field(None, description="Tags associated with job")
    
    # Time tracking
    actual_time: float | None = Field(None, description="Actual time spent", alias="actualTime")
    estimated_time: float | None = Field(None, description="Estimated time", alias="estimatedTime")
    
    # Other metadata
    image_id: str | None = Field(None, description="Image ID", alias="imageId")
    open_edge_id: str | None = Field(None, description="OpenEdge ID", alias="openEdgeId")
    fieldassists: list[dict] | None = Field(None, description="Field assists")
    
    # Integration fields
    sunlight_status_and_id: dict | None = Field(None, description="Sunlight status and ID", alias="sunlightStatusAndId")
    sunlight_events: dict | None = Field(None, description="Sunlight events", alias="sunlightEvents")
    
    # Stage dates
    stage_dates_overrides: dict | None = Field(None, description="Stage dates overrides", alias="stageDatesOverrides")
    stage_dates_overrides_on: dict | None = Field(None, description="Stage dates overrides on flags", alias="stageDatesOverridesOn")
    ...
    solar: str | None = Field(None, description="Solar installation status", alias="Solar?")
    gutters: str | None = Field(None, description="Gutter work needed", alias="Gutters?")
    peril_type: str | None = Field(None, description="Type of peril/damage", alias="Peril Type:")
    insurance_company: str | None = Field(None, description="Insurance company name", alias="Insurance Company:")
    claim_number: str | None = Field(None, description="Insurance claim number", alias="Claim Number:")
    decking_type: str | None = Field(None, description="Type of roof decking", alias="Decking Type:")
    sales_rep_commission: str | None = Field(None, description="Sales rep commission details", alias="Sales Rep Commission:")
    shingle_layers: str | None = Field(None, description="Number of shingle layers", alias="Shingle Layers:")
    how_cooked: str | None = Field(None, description="Job complexity/condition rating", alias="How Cooked?")
    filed_storm_date: int | None = Field(None, description="Storm date filed (unix timestamp)", alias="Filed Storm Date:")
    roof_pitch: int | None = Field(None, description="Major roof pitch (X/12)", alias="Maj. Roof Pitch (X/12):")
    acv_rps_policy: bool | None = Field(None, description="ACV/RPS policy flag", alias="ACV/RPS Policy:")
    
    # Programmatic custom field names (legacy - prefer the named fields above)
    cf_string_2: str | None = Field(None, description="Custom string field 2 (maps to Solar?)")
    cf_string_3: str | None = Field(None, description="Custom string field 3 (maps to Gutters?)")
    cf_string_7: str | None = Field(None, description="Custom string field 7 (maps to Peril Type)")
    cf_string_8: str | None = Field(None, description="Custom string field 8 (maps to Insurance Company)")
    cf_string_9: str | None = Field(None, description="Custom string field 9 (maps to Claim Number)")
    cf_string_13: str | None = Field(None, description="Custom string field 13 (maps to Decking Type)")
    cf_string_19: str | None = Field(None, description="Custom string field 19 (maps to Sales Rep Commission)")
    cf_string_26: str | None = Field(None, description="Custom string field 26 (maps to Shingle Layers)")
    cf_string_27: str | None = Field(None, description="Custom string field 27 (maps to How Cooked?)")
    cf_date_1: int | None = Field(None, description="Custom date field 1 (maps to Filed Storm Date)")
    cf_long_2: int | None = Field(None, description="Custom long field 2 (maps to Maj. Roof Pitch)")
    cf_boolean_1: bool | None = Field(None, description="Custom boolean field 1 (maps to ACV/RPS Policy)")
...
class JobNimbusFileResponse(BaseModel):
    ...
    # Status flags
    is_active: bool = Field(True, description="Whether the file is active", alias="isActive")
    is_archived: bool = Field(False, description="Whether the file is archived", alias="isArchived")
    is_private: bool = Field(False, description="Whether the file is private", alias="isPrivate")
    
    # Classification
    record_type: int = Field(..., description="Record type ID", alias="recordType")
    record_type_name: str = Field(..., description="File type name", alias="recordTypeName")
    ...
    # Relationships
    primary: RelatedEntity | None = Field(None, description="Primary related entity")
    related: list[RelatedEntity] | None = Field(None, description="Related entities (jobs, contacts)")
    owners: list[OwnerInfo] | None = Field(None, description="List of owners")
...
class JobNimbusFilesListResponse(BaseModel):
    ...
    results: list[JobNimbusFileResponse] = Field(..., description="List of files", alias="files")
