...
const envSchema = v.object({
   ...
   * will resemble a URL such as: http://localhost:8080.
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@maive/brand/logos': path.resolve(
        __dirname,
        '../../packages/brand/logos',
      ),
      '@maive/brand/fonts': path.resolve(
        __dirname,
        '../../packages/brand/fonts',
      ),
      '@maive/brand': path.resolve(__dirname, '../../packages/brand'),
    },
  },
});
