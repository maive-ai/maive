...
export const WorkflowsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost: async (projectId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost', 'projectId', projectId)
            const localVarPath = `/api/workflows/generate-project-summary/{project_id}`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const WorkflowsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectSummary>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WorkflowsApi.generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const WorkflowsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId: string, options?: RawAxiosRequestConfig): AxiosPromise<ProjectSummary> {
            return localVarFp.generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class WorkflowsApi extends BaseAPI {
     ...
     * @memberof WorkflowsApi
     */
    public generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId: string, options?: RawAxiosRequestConfig) {
        return WorkflowsApiFp(this.configuration).generateProjectSummaryApiWorkflowsGenerateProjectSummaryProjectIdPost(projectId, options).then((request) => request(this.axios, this.basePath));
    }
}
