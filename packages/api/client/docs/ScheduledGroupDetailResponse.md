...
**members** | [**Array&lt;ScheduledGroupMemberResponse&gt;**](ScheduledGroupMemberResponse.md) | List of group members | [default to undefined]
...
```typescript
import { ScheduledGroupDetailResponse } from './api';

const instance: ScheduledGroupDetailResponse = {
    id,
    user_id,
    name,
    frequency,
